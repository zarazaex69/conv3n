...
func NewWorkerPoolV2(size int, runtimePath, workerScript string) (*WorkerPoolV2, error) {
	if size <= 0 {
		size = 4
	}
...
func (p *WorkerPoolV2) startWorker(id int) (*BunWorker, error) {
...
func (p *WorkerPoolV2) dispatcher() {
	defer p.wg.Done()
...
func (p *WorkerPoolV2) executeTask(task *WorkerTask) {
	defer p.wg.Done()
...
func (p *WorkerPoolV2) getHealthyWorker() *BunWorker {
...
func (p *WorkerPoolV2) Submit(ctx context.Context, scriptPath string, input any, timeout time.Duration) (any, error) {
...
func (p *WorkerPoolV2) Stats() map[string]any {
